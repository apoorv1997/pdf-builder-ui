...
export const dummyAuctions: AuctionItem[] = [
  ...
  },
  {
    ...
    categoryPath: ['Computers', 'Laptops', 'Business Laptops'],
    sellerId: 2,
    sellerName: 'Jane Smith',
    startingPrice: 2500,
    currentBid: 2850,
  ...
  },
  {
    ...
    categoryPath: ['Computers', 'Laptops', 'Gaming Laptops'],
    sellerId: 2,
    sellerName: 'Jane Smith',
    startingPrice: 1800,
    currentBid: 2100,
